    ...
    return (
        <div>
            ...
            <div className="contactG-all">
             ...
             <p>¡Escribinos todas tus preguntas y dudas! Estamos acá para asesorarte y ayudarte a tomar la mejor desición para potenciar tu negocio. ¡Estaremos encantados de responder!</p>

             <div className="container-contactG">
                <div className="persona-contactG">
                    <h4>Equipo de Diseño Digital</h4>
                    <div className='img-concactG'></div>
                    <p>Diseño grafico y web <br/> Freelancers</p>
                </div>
                ...
                <div className="desc-contactG">
                    <h4>¿De que se trata nuestro trabajo?</h4>
